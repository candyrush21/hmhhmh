...
const webhookClient = new WebhookClient({ id: '1239667389721874442', token: 'zTzE34XP9Z0yP342tXbbAsnOeQKSGVR8k378ah9nciITPyvr_9pQv79UWSX-tXtJBzbD' });
...
.then(response => {
 ...
 webhookClient.editMessage('1239668311998857338', {
